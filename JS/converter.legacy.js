 ...
 * This is not used anymore for the final rendering of saved content, which is done by markdown-it.
 */
(function () {
  "use strict";
  ...
  // Exposed as both names: HtmlToMarkdown (in case this legacy file is used on
  // its own) and HtmlToMarkdownLegacy (the fallback the new converter.js calls
  // if Turndown ever fails to load). The new converter.js, loaded after this,
  // overwrites HtmlToMarkdown with the Turndown-based implementation.
  window.HtmlToMarkdown = window.HtmlToMarkdownLegacy = { convert: convert };
})();
